...
const AddEducation = ({addEducation, history}) => {
    ...
    const onChange = e => setFormData({ ...formData, [e.target.name]: e.target.valie });
        ...
        <Fragment>
            ...
            <form class="form" onSubmit={e => {
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                <p><input checked={current} type="checkbox" name="current" value="" value={current} onChange={e => {setFormData({...formData, current: !current}); toggleDisabled(!toDateDisabled);}}/>{' '}Current School</p>
              </div>
              <div class="form-group">
                <h4>To Date</h4>
